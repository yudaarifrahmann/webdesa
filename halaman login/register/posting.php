...
$dbname = "belajar_authentikasi"; // Your database name
...
// Assuming you have a logged-in user, fetch the username
// For example, using a user ID stored in session:
$username = $_SESSION['username']; // The user ID should be stored in the session upon login
...
<head>
  ...
  <title>Admin Desa | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin Desa
      </span>
    </a>
...
<body>
            ...
            <div class="col-md-10">
                <!-- Navbar -->
                <div class="navbar" style="display: flex; justify-content: space-between; align-items: center; background-color: #343a40; color: white; padding: 10px;">
                    <h5>Halaman Posting</h5>
                    <span>hi, admin</span>
                </div>
                    ...
                    <div class="main-content">
                        <form>
                            ...
                            <div class="editor-toolbar">
                                ...
                                <button type="button" onclick="execCmd('createLink', prompt('Enter the URL:', 'https://'))"><i class="fas fa-link"></i></button>
                                <button type="button" onclick="execCmd('insertImage', prompt('Enter the image URL:', 'https://'))"><i class="fas fa-image"></i></button>
                            </div>

                            <!-- Editable Div (Rich Text Editor) -->
